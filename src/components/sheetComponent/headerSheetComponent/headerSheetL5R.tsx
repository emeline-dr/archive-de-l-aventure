...
export default function HeaderSheetL5R(props: HeaderSheetL5RProps) {
    return (
        <>
            <div className='flex flex-wrap flex-col justify-evenly w-full lg:w-auto gap-[16px] z-1 bg-text-95 py-[16px] px-[32px] text-background rounded-sm'>
            ...
            <div className='absolute flex flex-col justify-between gap-[8px] end-[40px] w-[150px] h-[250px] z-1'>
                ...
                <div className='w-full flex flex-wrap bg-text p-[8px] text-background rounded-sm'>
                    <span className='self-center'>Exp. Dépensée</span> <span className='flex-1 text-center text-uncial-antiqua text-2xl'>{props.exp_spent}</span>
                </div>
                <div className='w-full flex flex-wrap bg-text p-[8px] text-background rounded-sm'>
                    <span className='self-center'>Exp. Restante</span> <span className='flex-1 text-center text-uncial-antiqua text-2xl'>{props.exp_saved}</span>
                </div>
            </div>
        </>
    )
