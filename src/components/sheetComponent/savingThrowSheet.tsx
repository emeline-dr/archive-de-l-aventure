            ...
            <div className="w-[300px] flex flex-wrap flex-col justify-start gap-[8px] p-[8px] rounded-[3px]">
                ...
                <div className="w-full flex flex-wrap justify-between gap-[8px] bg-primary rounded-[3px] p-[8px]">
                    <div className="flex-1">
                        ...
                        {Array.from({ length: props.success }).map((_, index) => (
                            <i
                                key={index}
                                className="fa-regular fa-heart text-[24px]"
                            ></i>
                        ))}
                        {props.success === 0 && <>0</>}
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        {Array.from({ length: props.failed }).map((_, index) => (
                            <i
                                key={index}
                                className="fa-solid fa-skull text-[24px]"
                            ></i>
                        ))}
                        {props.failed === 0 && <>0</>}
                    </div>
