    ...
    return (
        <div className="relative flex flex-wrap justify-start w-full lg:w-[49%] h-[135px] py-[27px] px-[16px] bg-primary rounded-[5px]">
            ...
            <div className="flex flex-wrap flex-col justify-center ms-[8px]">
                <span className="w-[150px] md:w-full lg:w-[100px] xl:w-full font-uncial-antiqua text-2xl truncate">{props.name}</span>
                <span className="w-[150px] md:w-full lg:w-[100px] xl:w-full truncate">{props.info}</span>
            ...
            <div className="absolute top-0 end-0 w-[127px] h-[135px]">
                <img src={props.system} alt="" className="absolute top-0 start-0 w-full h-full object-cover rounded-r-[5px] opacity-[.55]" />
