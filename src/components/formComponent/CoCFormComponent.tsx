        ...
        >
                            ...
                            <div className='w-[240px]'>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const newStatInt = e.target.value !== '' ? parseInt(e.target.value, 10) * 2 : 0;
            ...
            <div className="w-full mt-[40px]">
                <label className="block text-xl font-uncial-antiqua mb-[8px]">
                    Compétences de l'investigateur <i className='font-crimson-text text-sm'>(max. {exportStatInt} pts)</i>
                </label>
