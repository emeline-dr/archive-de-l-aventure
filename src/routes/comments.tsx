        ...
        <main className="flex-1 p-8 px-20">
          ...
          <div className="bg-[#f9edcd] border border-[#e2c799] p-4 rounded">
            <p className="text-sm text-gray-800">
              ...
              lobortis nisl cursus bibendum sit nulla accumsan sodales ornare.
              At urna viverra non suspendisse neque, lorem. Pretium condimentum
              pellentesque gravida id etiam sit sed arcu euismod. Rhoncus proin
              orci duis scelerisque molestie cursus tincidunt aliquam.
            </p>
          </div>
        </main>
      </div>
