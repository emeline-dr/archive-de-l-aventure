      ...
      <div className="absolute top-0 left-0 h-screen w-full bg-text-75">
        <div className="w-full mt-[80px]">
          <img
            src={logoHome}
            alt=""
            className="h-[135px] object-cover mix-blend-hard-light mx-auto"
          />
        ...
        <div className="w-full lg:w-1/2 flex flex-wrap flex-col content-center justify-center mt-[64px]">
          ...
          <Link to="/signIn" className="h-fit relative z-1 mt-[40px] mx-auto">
            <button className="btn btn-accent">Rejoignez-nous !</button>
          </Link>
        </div>
      ...
      <div className="w-full flex flex-wrap">
        ...
        <div className="flex flex-wrap justify-center content-center h-screen w-full lg:w-1/2">
          <p className="w-3/4 text-lg">
            Que vous descendiez dans un donjon infesté de gobelins, arpentiez
            les ruelles d'une mégalopole cybernétique, ou fuyiez une entité
            ancienne à bord d’un vaisseau en perdition… vos personnages ont
            besoin d’un refuge fiable.
            <br />
            <br />
            Ici, ils trouvent bien plus qu’une simple fiche : un bastion
            numérique pour suivre leur évolution, noter leurs exploits, et
            préparer leurs prochaines aventures.
            <br />
            <br />
            Créez, gérez et personnalisez vos fiches de personnage pour tous vos
            univers de jeu de rôle. Système médiéval-fantastique,
            science-fiction, horreur, post-apo ou univers maison — tout est
            possible.
          </p>
